...
public class loginSteps extends BrowserSetup {
    ...
    LoginPage login = new LoginPage(driver);    // create ref variable to access login page
    ...
    public void iEnterInvalidPassword() {login.enterPassword(Hook.password);}
    @When("I click login button")
    public void iClickLoginButton() {login.signinButtonClick();}
